{*
 ...
 +--------------------------------------------------------------------+
 | Customization for org.civicoop.enhancedtags                        |
 | add Coordinator name to page                                       |
            ...
            <table id="options" class="display">
              <thead>
                    <tr>
                      ...
                      {* add coordinator for org.civicoop.enhancedtags *}
                      <th>{ts}Coordinator{/ts}</th>
                ...
                <tr class="{cycle values="odd-row,even-row"} {$row.class} crm-tag crm-entity" id="tag-{$row.id}">
                    ...
                    {* add coordinator for org.civicoop.enhancedtags *}
                    <td class="crm-tag-coordinator">{$coordinators[$row.id]}</td>
